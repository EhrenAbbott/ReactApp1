...
import { chooseCarMake, chooseCarModel, chooseProductionYear, chooseCarColor } from "../redux/slices/RootSlice";
...
const ContactForm = (props:ContactFormProps) => {
  ...
  const onSubmit = (data: any, event: any) => {
    ...
    if (props.id && props.id.length > 0) {
      ...
      dispatch(chooseProductionYear(data.production_year));
    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <Input {...register('production_year')} name='production_year' placeholder="Production Year"/>
        </div>
